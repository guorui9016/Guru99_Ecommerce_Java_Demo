...
/*    public String[] getAllProductsName(){
    ...
    public WishListPage clickAddToWishList(WebElement product){
        WebElement addToWishList = product.findElement(By.className("link-wishlist"));
        highlight(addToWishList);
        addToWishList.click();
